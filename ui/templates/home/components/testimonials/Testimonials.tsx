        ...
        >
          {CONTENTS.map(item => (
            <div key={item.index} className={styles['testimonials-slide-wrapper']}>
              <div className={styles['testimonials-slide-left-block']}>
                <Rate
                  disabled
              ...
              <div
                className={styles['testimonials-slide-right-block']}
                style={isMobile ? { paddingBottom: activeIndex === 2 ? 28 : 0 } : {}}
              >
                <Image alt="" width={596} height={413} quality={100} src={item.img} />
              </div>
            </div>
          ))}
        </Carousel>
