...
const ICONS = [UserFriendlyIcon, OnsiteSupportIcon, ManagementIcon, EfficientFastIcon];
  ...
  return (
    <div>
      <Banner
        ...
        content={<>{common('business_categories.bar_nightclub')}</>}
        button={
          <GetPricingButton
      ...
      <BreadCard isGrey>
        <SolutionList
          headings={[
            ...
            ` ${common('pos_system_for')} ${common('business_categories.bar_nightclub')}`,
          ]}
          content={[
            {
      ...
      <BreadCard>
        <Heading level={3}>{`${common('business_categories.bar_nightclub')} ${common(
          'must_have',
        )}`}</Heading>
