...
export const PrivacyPolicy = () => {
  return (
    <div className={styles['privacy-policy']}>
      <BreadCard>
        <SectionHeading centered centerSp level={2} heading="Privacy Policy" />

        <div className={styles['privacy-policy_inner']}>
          <Flex direction="column" gap={16}>
            <Text>
              https://extrabread.com/ website is owned by Extrabread, which is a data controller of
              your personal data.
            </Text>
            <Text>
              We have adopted this Privacy Policy, which determines how we are processing the
              information collected by https://extrabread.com/, which also provides the reasons why
              we must collect certain personal data about you. Therefore, you must read this Privacy
              Policy before using https://extrabread.com/ website.
            </Text>
            <Text>
          ...
          <div>
            ...
            <Text>
              When you visit the https://extrabread.com/, we automatically collect certain
              information about your device, including information about your web browser, IP
              address, time zone, and some of the installed cookies on your device. Additionally, as
              you browse the Site, we collect information about the individual web pages or products
              you view, what websites or search terms referred you to the Site, and how you interact
              with the Site. We refer to this automatically-collected information as “Device
              Information.” Moreover, we might collect the personal data you provide to us
          ...
          <div>
            ...
            <Space direction="vertical" size={16}>
              ...
              <Text>
                ...
                is mandatory are welcome to contact us via info@bestpos.com.
              </Text>
            </Space>
          </div>
          ...
          <div>
            ...
            <Space direction="vertical" size={16}>
              ...
              <ul className={styles['privacy-policy_right-list']}>
          ...
          <div>
            ...
            <Text>
              ...
              parties&#39; privacy practices. We encourage you to be aware when you leave our
          ...
          <div>
            ...
            <Text>
              ...
              Information, you may send an email to <a href={`mailto:${EMAIL}`}>{EMAIL}</a>
            </Text>
          </div>
        </div>
      </BreadCard>
