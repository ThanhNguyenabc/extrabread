...
const toastVariants = cva(
  `group pointer-events-auto relative w-full items-center justify-between space-x-4 
  top-0 right-0 border bg-white flex fixed md:max-w-[400px] md:top-4 md:right-4
  overflow-hidden rounded-md p-5 pr-8 shadow-lg transition-all 
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    {...props}
  >
    <IcClose className="text-2xl" color="white" />
  </ToastPrimitives.Close>
));
